    ...
    <Modal
      ...
      footer={
        <div className="flex gap-3">
          ...
          <button type="submit" form="ingreso-form" disabled={saving} className="flex-1 py-2.5 bg-[var(--good)] text-white text-sm uppercase tracking-wide font-bold hover:brightness-110 transition-all disabled:opacity-50 rounded-md">{saving ? 'Guardando…' : 'Registrar ingreso'}</button>
        </div>
      }
    >
